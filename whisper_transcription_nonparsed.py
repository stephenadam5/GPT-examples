# This Python script uses Microsoft's Azure Whisper model for accurate batch speech-to-text transcription. Configure 
# properties, transcribe single or multiple audio files efficiently, and monitor transcription status. Ideal for high-quality
# audio transcription at scale with the Whisper model.
...
MODEL_REFERENCE = '<guid_of_custom_model>'  # guid of a custom model
...
def transcribe():
    ...
    properties.diarization = swagger_client.DiarizationProperties(
        swagger_client.DiarizationSpeakersProperties(min_count=1, max_count=6))
    ...
    transcription_definition = transcribe_with_custom_model(
        client, RECORDINGS_BLOB_URI, properties)
    ...
    while not completed:
        ...
        if transcription.status == "Succeeded":
            ...
            for file_data in _paginate(api, pag_files):
                ...
                # Write the results to a JSON file, overwriting the existing file if it exists
